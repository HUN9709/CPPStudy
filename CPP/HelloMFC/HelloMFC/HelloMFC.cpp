...
// HelloMFC.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CHelloMFCApp, CWinApp)
	...
	ON_COMMAND(ID_FILE_NEW, &CHelloMFCApp::OnFileNew)
END_MESSAGE_MAP()
...
BOOL CHelloMFCApp::InitInstance()
{
	...
	m_hMDIMenu  = ::LoadMenu(hInst, MAKEINTRESOURCE(IDR_HelloMFCTYPE));
	m_hMDIAccel = ::LoadAccelerators(hInst, MAKEINTRESOURCE(IDR_HelloMFCTYPE));
...
void CHelloMFCApp::OnFileNew()
{
	CMainFrame* pFrame = STATIC_DOWNCAST(CMainFrame, m_pMainWnd);
	// 새 MDI 자식 창을 만듭니다.
	pFrame->CreateNewChild(
		RUNTIME_CLASS(CChildFrame), IDR_HelloMFCTYPE, m_hMDIMenu, m_hMDIAccel);
}
